...
<?php is_tag(); ?>
	...
	<div class="inside">
		<div class="primary">
			...
			<h1><?php printf(__('Archive for the "%s" Category', 'hemingway'), single_cat_title(null, false)); ?></h1>
			

			<?php /* If this is a tag archive */ } elseif (is_tag()) { ?>
			<h1><?php printf(__('Archive for the "%s" Tag', 'hemingway'), single_tag_title(null, false)); ?></h1>
			
			<?php /* If this is a daily archive */ } elseif (is_day()) { ?>
			<h1><?php printf(__('Archive for %s', 'hemingway'), get_the_time('F jS, Y')); ?></h1>
			
		 <?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
			<h1><?php printf(__('Archive for %s', 'hemingway'), get_the_time('F, Y')); ?></h1>
	
			<?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
			<h1><?php printf(__('Archive for %s', 'hemingway'), get_the_time('Y')); ?></h1>
	...
	<div class="secondary">
		...
		<div class="featured">
			<p><?php printf(__('Welcome to the archives here at %s. Have a look around.', 'hemingway'), get_option('blogname')); ?></p>
		</div>
	</div>
	<div class="clear"></div>
	</div>
